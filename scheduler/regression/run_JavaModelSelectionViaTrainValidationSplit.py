...
def gen_data(data_path, hdfs_path):
    ...
    os.system("python ForLinearRegression.py {0} {1} {2}"
...
def run_jar(hdfs_path, local_path):
    ...
    cmd = '/home/spark-2.1.0-bin-hadoop2.6/bin/spark-submit --class JavaModelSelectionViaTrainValidationSplitExample ' \
          ...
          '--executor-cores {3} ~/wttttt/spark-examples/spark-examples-2.0-SNAPSHOT.jar {4}' \
        .format(randint(1, 6), driver_mem, exe_mem, exe_cores, hdfs_path)
...
if __name__ == "__main__":
    ...
    data_path = "/home/testData/linearRegre/lin11111.txt"
    hdfs_path = "/home/testData/linearReg/lin11111.txt"
