...
def run_jar(hdfs_path, local_path):
    ...
    cmd = '/home/spark-2.1.0-bin-hadoop2.6/bin/spark-submit --class JavaGeneralizedLinearRegressionExample ' \
        ...
        .format(randint(1, 6), driver_mem, exe_mem, exe_cores, hdfs_path, randint(100, 10000))
...
if __name__ == "__main__":
    ...
    hdfs_path = "/home/testData/linearReg/lin1.txt"
