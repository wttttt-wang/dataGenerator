...
def run_jar(hdfs_path, local_path):
    ...
    cmd = '/home/spark-2.1.0-bin-hadoop2.6/bin/spark-submit --class RandomForestTestRegress ' \
        ...
        .format(randint(1, 6), driver_mem, exe_mem, exe_cores, hdfs_path, randint(2, 10), randint(3, 9))
...
if __name__ == "__main__":
    ...
    data_path = "/home/testData/ran_forest_reg1.txt"
    hdfs_path = "/home/testData/ran_forest_reg1.txt"
