...
def run_jar(hdfs_path):
    ...
    cmd = '/home/spark-2.1.0-bin-hadoop2.6/bin/spark-submit --class RandomForestTestClassify ' \
        ...
        .format(driver_mem, exe_mem, exe_cores, hdfs_path, randint(3, 9), randint(3, 8))
...
if __name__ == "__main__":
    ...
    hdfs_path = "/testData/random_forest_class1.txt"
