...
if __name__ == "__main__":
    ...
    decision_tree(reg_x_train, reg_y_train, reg_x_test, reg_y_test)
    print 'running gradient_boosting'
    gradient_boosting(reg_x_train, reg_y_train, reg_x_test, reg_y_test)
    print 'running neural_nlp'
    neural_nlp(reg_x_train, reg_y_train, reg_x_test, reg_y_test)
